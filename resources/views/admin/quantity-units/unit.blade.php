...
<div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
  ...
  <a href="{{route('admin.quantity-units.add')}}" class="btn btn-success font-medium rounded-pill px-4">Add new</a>
</div>
                ...
                <tbody>
                    ...
                    @for ($i = 0; $i < count($pageData->QuantityUnits); $i++)
                        <tr>
                            ...
                            <td class="">
                                <a href="{{route('admin.quantity-units.edit',['encodedId' => base64_encode($pageData->QuantityUnits[$i]->id)])}}"
