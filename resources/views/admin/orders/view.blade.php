...
<section class="h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="col-lg-8 col-xl-7 col-md-8 col-12 gap-2 mb-4  d-flex align-items-center justify-content-end">
            ...
            <a class="btn btn-success"
                href="{{route('admin.order.is_approved',['encodedId' => base64_encode($pageData->order->id)])}}">Set
                Approved</a>
            ...
            <a class="btn btn-danger"
                href="{{route('admin.edit.order',['encodedId' => base64_encode($pageData->order->id)])}}"><svg
