...
<div class="card w-100 position-relative overflow-hidden">
    ...
    <div class="card-body p-4">
        <div class="table-responsive rounded-2 py-5 mb-4">
            <table
                class="table border text-nowrap customize-table mb-0 align-middle @if ($pageData->customers && count($pageData->customers) != 0) datatable-select-inputs @endif">
                ...
                <tbody>
                    ...
                    @for ($i = 0; $i < count($pageData->customers); $i++)
                        ...
                        <input class="id" type="hidden" name="id[]" value="{{$pageData->customers[$i]['id']}}">
                            ...
                            <td class="">
                                <a href="{{route('admin.customer.all.view',['encodedId' => base64_encode($pageData->customers[$i]["id"])])}}"
                                ...
                                <a href="{{route('admin.customer.edit',['encodedId' => base64_encode($pageData->customers[$i]["id"])])}}"
