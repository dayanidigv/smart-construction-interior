                ...
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{route('category.view',['role'=>'manager'])}}"
                                    aria-expanded="false">
                                    <span>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="{{route('manager.quantity-units')}}"
                                    aria-expanded="false">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <div class="message-body" data-simplebar>
                                        ...
                                        @for ($i = 0; $i < min(count($displayReminder), 7); $i++) <a
                                            href="{{route('manager.reminder.view',['encodedId' => base64_encode($displayReminder[$i]->id)])}}"
                                    ...
                                    <div class="py-6 px-7 mb-1">
                                        <a href="{{route('manager.reminder.list')}}"><button
                    ...
                    <div class="row ">
                        <div class="col order-md-1 order-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item text-muted"><a href="/">{{ ucfirst($user->role)}}</a>
                                    </li>
