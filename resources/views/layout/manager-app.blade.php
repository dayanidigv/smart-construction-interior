            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar>
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link @if ($title == 'Index') active @endif" href="{{route('manager.index')}}"
                            aria-expanded="false">
                            <span>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{route('enquiries.new',['role'=>'manager'])}}" class="sidebar-link ">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">New</span>
                            ...
                            <li class="sidebar-item">
                                <a href="{{route('enquiries.list',['role'=>'manager'])}}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">List</span>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="{{route('manager.new.order')}}" class="sidebar-link ">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">New</span>
                            ...
                            <li class="sidebar-item">
                                <a href="{{route('manager.list.order')}}" class="sidebar-link">
                                    <div class="round-16 d-flex align-items-center justify-content-center">
                                        <i class="ti ti-circle"></i>
                                    </div>
                                    <span class="hide-menu">List</span>
                  ...
                  <a class="sidebar-link" href="" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('category.view',['role'=>'manager'])}}" aria-expanded="false">
                            <span>
                                ...
                                <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    @if (count($displayReminder) > 0)
                                        @for ($i = 0; $i < min(count($displayReminder), 7); $i++)
                                            <a href="{{route('manager.reminder.view',['encodedId' => base64_encode($displayReminder[$i]->id)])}}" class="py-6 px-7 d-flex align-items-center dropdown-item">
                                    ...
                                    @if (count($displayReminder) > 6)
                                        <div class="py-6 px-7 mb-1">
                                            <a href="{{route('manager.reminder.list')}}"><button class="btn btn-outline-primary w-100"> See All Reminders </button></a>
                                        </div>
                                    @endif
                                </div>
                            </li>
