      ...
      <div class="card-body">
        ...
        <form action="{{route('customer.store')}}" method="post">
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <div class="form-floating">
                    <textarea type="text" name="address" id="address" value="{{old('address')}}" class="form-control @error('address') is-invalid @enderror" placeholder="name@example.com" required>{{old('address')}}</textarea>
