...
<div class="row align-items-center">
    <div class="col-sm-8 col-md-8 col-lg-5 mx-auto">
        <div class="card">
            <div class="card-body">
                <h5 class="mb-3">
                    <a href="{{route('manager.reminder.list')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="form-floating">
                                <input type="text" name="title" value="{{old('title',$pageData->title)}}" id="title"
                                    class="form-control h-100 @error('title') is-invalid @enderror"
                                    placeholder="Enter reminder title here" required />
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-floating">
                                <textarea name="description" id="description"
                                    ...
                                    placeholder="Enter reminder description (optional)">{{old('description',$pageData->description)}}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                                <div class="form-floating">
                                    <input type="datetime-local"
                                        value="{{old('reminder_time',$pageData->reminder_time)}}" name="reminder_time"
                                        id="reminder_time"
                                        class="form-control @error('reminder_time') is-invalid @enderror" required 
                                        data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Update a time for a notification about this reminder."/>
