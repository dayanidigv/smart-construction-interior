@extends('manager.quantity-units.unit')
@section('quantity-units')
<div class="row align-items-center">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <div class="card-body">
                <h5 class="mb-3">New Quantity Units</h5>
                <form action="{{route('quantity-units.store')}}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-3">
                            <div class="form-floating">
                                <input type="text" name="description" id="description"
                                    ...
                                    placeholder="Enter Description here" value="{{old('description')}}" />
